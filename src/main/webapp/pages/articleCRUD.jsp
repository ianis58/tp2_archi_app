                        ...
                        <table class="table table-sm table-hover table-bordered">
                            ...
                            <s:iterator value="listArticles" var="article">
                                <tr>
                                    ...
                                    <td>
                                        <s:url var="editURL" action="editArticleLink">
                                            <s:param name="id" value="%{#article.idArticle}"></s:param>

                                            <%--
                                            <s:param name="nom" value="%{#article.nom}"></s:param>
                                            <s:param name="marque" value="%{#article.marque}"></s:param>
                                            <s:param name="ref" value="%{#article.reference}"></s:param>
                                            <s:param name="prix" value="%{#article.prix}"></s:param>
                                            <s:param name="desc" value="%{#article.description}"></s:param> 
                                            <s:param name="sousCat" value="%{#article.getSouscategories}"></s:param>
                                            <s:param name="veh" value="%{#article.getVehicules}"></s:param>
                                            --%>
                                        </s:url>
